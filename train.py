...
def get_arguments() -> argparse.Namespace:
    ...
    parser.add_argument("--pubtabnet_jsonl_path", type=str, required=True, help="Path to PubTabNet JSONL file")
...
def main(args: argparse.Namespace):
    with OptionalTemporaryDirectory() as tmp_dir:
        pubtabnet_to_yolo = PubTabNetToYOLO(args.pubtabnet_jsonl_path, tmp_dir)
